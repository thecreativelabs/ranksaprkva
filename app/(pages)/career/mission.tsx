    ...
    <h2 className='md:text-3xl text-lg w-auto font-semibold text-[#3B0D17]'>Our Values</h2>
      <div className="grid sm:grid-cols-2 md:grid-cols-3 mt-10 gap-8 md:gap-8">
        {data.it.map((item, index) => (
          <div
            key={index}
            className="bg-[#F0F0ED] md:h-[270px] w-auto h-auto md:w-[400px] flex flex-col gap-4 mb-2 md:mb-6 items-start group hover:border-slate-100 border rounded transition-all px-8 py-6"
          >
