    ...
    <Container>
      <div className="mt-20 flex justify-center items-center">
        <div className="h-auto text-center">
          <p className="md:text-5xl w-full leading-10 tracking-wide mx-auto font-medium text-3xl font-tertiary mt-4 text-[#3B0D17] md:w-[70%]">
            {data.heading}
          </p>
          ...
          <div key={index} className="grid md:grid-cols-2 py-10">    
            ...
            <div className="grid place-items-center">
              <div className="max-w-lg">
                <h3 className="md:text-3xl text-xl text-[#3B0D17] tracking-wider md:tracking-normal font-serif font-semibold md:font-semibold mt-4">
                  {feature?.heading}
                </h3>
                <p className="mt-4 text-[#3B0D17] tracking-wider">
                  {feature?.description}
                </p>
              </div>
            </div>
