...
const Hero = ({
  ...
  return (
    <div className="relative overflow-hidden flex flex-wrap justify-center bg-graybg">
      <div className="ml-[20px] w-auto text-left md:w-auto lg:max-w-4xl xs:pt-4 sm:pt-4 md:mt-4 mb-2 flex flex-col items-left md:items-start md:text-left">
        <h1 className="w-auto md:w-auto z-10 tracking-wide mt-6 text-3xl md:text-4xl lg:text-6xl xl:text-8xl md:text-left text-left lg:text-left text-dark-red font-tertiary">
          {data.title}
        </h1>
      ...
      <div className="z-0 w-full md:w-[560px] mt-10 md:flex flex flex-col pl-8 md:p-8 text-center">
        <img
          ...
          className="h-[80vh] block md:absolute right-0 top-0"
