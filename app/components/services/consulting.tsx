...
export default function CaseStudyConsulting(features: {
  ...
  const data = {
    ...
    cards: [
      {
        Icon: (
          <FaAlignRight className="w-[35px] h-[35px] font-light text-light-pink" />
        ),
      ...
      {
        Icon: (
          <FaAccusoft className="w-[35px] h-[35px] font-light text-light-pink" />
        ),
      ...
      {
        Icon: (
          <GrKey className="w-[35px] h-[35px] font-light text-light-pink" />
        ),
  ...
  return <Consulting {...features} data={data} />;
}
