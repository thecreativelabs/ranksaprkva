...
const data = {
    ...
    tagline: "Understanding which of your target keywords you're ranking for and and how well your pages rank for them provides valuable insight into the effectiveness of your SEO strategy.",
    image: 'https://cdn.shortpixel.ai/spai/ret_img/victorious.com/wp-content/uploads/2023/09/Staff-Writer-Profile-Pic-96x96.webp',
                ...
                <div className="w-[100%] flex sm:flex-row flex-col gap-[20px] sm:gap-[0px] items-center">
                    <div className="w-[80%]">
                        ...
                        <div className="flex items-center sm:gap-[20px] gap-[10px] mt-[20px]">
                            <img src={data.image} className="sm:h-[90px] sm:w-[90px] h-[40px] w-[40px] rounded-[50%] border-[2px] border-solid border-light-pink" alt="image" />
                            <p className="text-dark-red flex capitalize sm:mt-[-10px] text-[10px] lg:text-base font-normal font-DM-Sans leading-[12px] sm:leading-[29.70px]">
                                by {data.author} <span className="sm:w-[25px] w-[40px]" ></span> {data.date} <span className="sm:w-[25px] w-[40px]" /> {data.topic}
                            </p>
