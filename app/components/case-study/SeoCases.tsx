  ...
  return (
    <Container>
      <div className="flex justify-center items-center">
        <div className="w-full relative min-h-fit flex justify-center items-center flex-col">
          <div className="w-full flex m justify-center items-center mt-[70px]">
            <p className="text-dark-red text-[27.30px] lg:text-[46px] font-normal font-Amiri tracking-wide leading-[35px] sm:leading-[67.34px]">
              {heading}
            </p>
          </div>
