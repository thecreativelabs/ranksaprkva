  ...
  return (
    ...
    >
      <div className="flex justify-center items-center">
        ...
        <p
          className={`font-bold text-xxxl font-primary text-${props.index % 3 === 0 ? "dark-red" : props.index % 3 === 1 ? "lightyellow" : "dark-red"}`}
        >
          {props.data.title}
        </p>
      </div>
      <p
        className={`text-sm ml-[8px]  font-primary font-normal tracking-wider text-${props.index % 3 === 0 ? "dark-red" : props.index % 3 === 1 ? "lightyellow" : "dark-red"}`}
      >
        {props.data.content}
      </p>
    </div>
