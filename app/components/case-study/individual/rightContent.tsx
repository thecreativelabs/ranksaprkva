export default function RightContent() {
  ...
  return (
    <div className="lg:w-[30%] w-[100%] p-[40px] bg-graybg">
      <p className=" font-DM-sans text-[22px] font-bold">{data.content}</p>
      ...
      <p className=" pt-[30px] font-DM-sans text-[22px] font-bold">Services</p>
      <ul className=" list-disc mt-[10px] ml-[18px]">
        {data.services.map((service: any, i: any) => {
          return service.link == "" ? (
            <li key={i} className="text-[17px] font-DM-sans">
              {" "}
              {service.text}{" "}
            </li>
          ) : (
