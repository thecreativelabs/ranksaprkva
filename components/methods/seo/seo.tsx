...
export default function SEO(): JSX.Element {
    return (
        <div className="bg-white relative z-10 sm:py-0 py-4 mt-[50px] flex flex-col gap-[10%] justify-center items-center w-[90%] border-t-[3px] border-solid border-yellow-500 h-[45%]">
